...
// clang-format off
POINT_CLOUD_REGISTER_POINT_STRUCT(ouster0_ros::Point,
                                  (float, x, x)
                                      (float, y, y)
                                      (float, z, z)
...
enum class LidarType { AVIA = 1, VELO32, OUST64, OUST032 };
...
class PointCloudPreprocess {
   ...
   private:
    ...
    void Oust32Handler(const sensor_msgs::PointCloud2::ConstPtr &msg);
